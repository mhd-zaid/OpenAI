...
const SocialShare = () => {
  ...
  return (
    <div className="flex space-x-10 justify-center">
      ...
      <div className="cursor-pointer">
        <a
          href={`mailto:?subject=Regarde cette recette&body=J'ai trouvé cette recette incroyable et je pense que tu l'aimerais aussi ! Consulte-la ici : ${window.location.href} \n\nN'oublie pas de visiter notre site pour plus de recettes délicieuses.`}
        >
          <Icon
            icon="arcticons:mail"
            fontSize={30}
