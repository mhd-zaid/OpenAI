      ...
      <div className="grid grid-cols-12 p-2 bg-white z-10">
        ...
        <div className="col-span-1 flex justify-center items-center">
          <button onClick={() => setIsMenuOpen(!isMenuOpen)}
            ...
            <svg className="fill-yellow-400 h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <title>Menu</title>
        ...
        {/* Logo */}
        <button onClick={() => navigate("/")} className="lg:col-span-2 md:col-span-4 col-span-10 flex items-center justify-center flex-shrink-0 text-yellow-400 gap-2 effect-grew">
          <Icon icon="noto:man-cook-dark-skin-tone" fontSize={30} color={""} />
          <span className="font-semibold text-lg tracking-tight">Cuisine Connect</span>
        </button>
