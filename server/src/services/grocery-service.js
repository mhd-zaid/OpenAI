...
let groceryListPrompt =
  "Ce qui suit est une demande pour générer une liste de courses basée sur les ingrédients et les quantités nécessaires\
...
class GroceryService {
  ...
  async getOpenAICompletion(recipeId) {
    const context = [];
    const recipe = await db.Quantity.findAll({
    ...
    const content =
      'Génère moi une liste de courses pour la recette suivante : ' +
